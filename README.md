# VSCP L1 Bootloader <!-- omit in toc -->
...
A generic VSCP L1 bootloader, which supports the [standard bootloader algorithm](#vscp-standard-bootloader-algorithm). It provides the possibility to program a new firmware image to a VSCP node.
